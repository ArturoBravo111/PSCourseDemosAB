    ...
    ForEach ($computer in $ComputerName) {
        ...
        Do {
            ...
            Try {
                ...
                Write-Verbose "Getting $servicename on $computer"
                $params = @{'CimSession' = $session
                            'Query'="SELECT * FROM Win32_Service WHERE Name = '$ServiceName'"
                            }
                            write-verbose $params.query
                $ret = Get-CimInstance @params

                $props = @{'ComputerName'= $ret.PSComputername
                            'ServiceName' = $ret.Name
                           'AccountName' =  $ret.StartName
                           }
